...
export default function Invite() {
  ...
  return (
    <>
      ...
      <form
        action=""
        className="fixed inset-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[500px] flex flex-col shadow-lg w-full justify-center bg-white z-50 "
        onSubmit={findTeamMate}
      >
        <section className="bg-white flex w-full flex-col p-4">
